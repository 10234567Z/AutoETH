      ...
      <div className="flex-1 px-4 sm:px-6 lg:px-8 py-20 z-10">
        <div className="max-w-7xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-400">Here is your agent's performance overview.</p>
            </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl shadow-lg p-6">
                        ...
                        <ul className="space-y-3 text-gray-300">
                            <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-green-500"></span>Registered for Round #12</li>
                            <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-blue-500"></span>Participated in validation — 98% accuracy</li>
                            <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-purple-500"></span>Earned 1.2 reputation points</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-6 shadow-lg">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center bg-black/50 p-3 rounded-lg">
                                ...
                                <span className="font-bold text-purple-400 text-lg">{agent.reputation}</span>
                            </div>
                            <div className="flex justify-between items-center bg-black/50 p-3 rounded-lg">
                                <span className="text-gray-400">Accuracy</span>
                                <span className="font-bold text-green-400 text-lg">{agent.accuracy}</span>
                            </div>
                            <div className="flex justify-between items-center bg-black/50 p-3 rounded-lg">
                                <span className="text-gray-400">Stake</span>
                                <span className="font-bold text-yellow-300 text-lg">{agent.stake}</span>
                            </div>
                        </div>
                    </div>
                    <div className="bg-black/40 border border-white/10 rounded-2xl p-6 shadow-lg">
